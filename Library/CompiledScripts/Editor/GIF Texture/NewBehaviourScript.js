...
exports.NewBehaviourScript = void 0;
let NewBehaviourScript = class NewBehaviourScript extends APJS.BasicScriptComponent {
    constructor() {
        super(...arguments);
        // ความเร็วพื้นฐาน
        this.speed = 100.0;
...
NewBehaviourScript = __decorate([
    component()
], NewBehaviourScript);
exports.NewBehaviourScript = NewBehaviourScript;
